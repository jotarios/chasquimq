...
class Producer:
    ...
    def pause(self) -> Awaitable[None]: ...
    def resume(self) -> Awaitable[None]: ...
    def is_paused(self) -> Awaitable[bool]: ...
    def remove(
        self, job_id: str, group: str
    ) -> Awaitable[dict[str, bool]]: ...
    def drain(self, group: str, drain_delayed: bool) -> Awaitable[int]: ...
    def clean(
        self, group: str, grace_ms: int, limit: int, state: str
    ) -> Awaitable[list[str]]: ...
    def obliterate(self, group: str) -> Awaitable[int]: ...
...
class Introspector:
    ...
    def get_job_counts(self) -> Awaitable[dict[str, Any]]: ...
    def get_job_state(self, job_id: str) -> Awaitable[str]: ...
    def get_job(self, job_id: str) -> Awaitable[Optional[dict[str, Any]]]: ...
    def get_jobs(
        self,
        state: str,
        offset: int = 0,
